...
import { tlDynamicFormRadioType, TlDynamicFormRadioModule } from './dynamic-form-radio.module';

describe('TlDynamicFormRadioModule', () => {
  beforeEach(async(() => {
  ...
  it('provides DYNAMIC_FORM_INPUT_TYPES',
    inject([DYNAMIC_FORM_INPUT_TYPES], (types: DynamicFormInputTypes) => {
      ...
      expect(types[0]).toEqual(tlDynamicFormRadioType);
