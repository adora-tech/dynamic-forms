...
import { NbDynamicFormDatepickerModule } from './dynamic-form-datepicker.module';

describe('NbDynamicFormDatepickerComponent', () => {
  let fixture: ComponentFixture<NbDynamicFormDatepickerComponent>;
  let component: NbDynamicFormDatepickerComponent;
  ...
  beforeEach(async(() => {
    ...
    fixture = TestBed.createComponent(NbDynamicFormDatepickerComponent);
