...
import { nbDynamicFormDatepickerType, NbDynamicFormDatepickerModule } from './dynamic-form-datepicker.module';

describe('NbDynamicFormDatepickerModule', () => {
  beforeEach(async(() => {
  ...
  it('provides DYNAMIC_FORM_INPUT_TYPES',
    inject([DYNAMIC_FORM_INPUT_TYPES], (types: DynamicFormInputTypes) => {
      ...
      expect(types[0]).toEqual(nbDynamicFormDatepickerType);
