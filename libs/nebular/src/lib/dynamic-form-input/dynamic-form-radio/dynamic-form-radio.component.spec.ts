...
import { NbDynamicFormRadioModule } from './dynamic-form-radio.module';

describe('NbDynamicFormRadioComponent', () => {
  let fixture: ComponentFixture<NbDynamicFormRadioComponent>;
  let component: NbDynamicFormRadioComponent;
  ...
  beforeEach(async(() => {
    ...
    fixture = TestBed.createComponent(NbDynamicFormRadioComponent);
