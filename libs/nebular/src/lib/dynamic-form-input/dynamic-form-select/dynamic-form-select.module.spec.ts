...
import { nbDynamicFormSelectType, NbDynamicFormSelectModule } from './dynamic-form-select.module';

describe('NbDynamicFormSelectModule', () => {
  beforeEach(async(() => {
  ...
  it('provides DYNAMIC_FORM_INPUT_TYPES',
    inject([DYNAMIC_FORM_INPUT_TYPES], (types: DynamicFormInputTypes) => {
      ...
      expect(types[0]).toEqual(nbDynamicFormSelectType);
